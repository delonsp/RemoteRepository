...
@synthesize pageOfQuestionnaire, questionnaireDictionary, questFromDict, totalofPages, dictOptions, resultados, partialScore, totalScore, listOfAnswers;
...
-(void) setQuestionnaireName:(NSString *)questName {
    ...
    NSBundle *bundle = [NSBundle mainBundle];
    NSString *path = [bundle pathForResource:self.questionnaireName ofType:@"plist"];
    NSDictionary *dict = [[NSDictionary alloc] initWithContentsOfFile:path];
