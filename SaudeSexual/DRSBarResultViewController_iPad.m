//
//  DRSBarResultViewController_iPad.m
//  SaudeSexual
//
...
@interface DRSBarResultViewController_iPad ()

-(void) configureAnswers;

@end

@implementation DRSBarResultViewController_iPad
@synthesize result;
...
- (void)viewDidLoad
{
    ...
    if (!self.result) {
        self.result = [[UILabel alloc] initWithFrame:CGRectMake(250, 250, 250, 150)];
